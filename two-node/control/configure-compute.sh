...
[DEFAULT]
sql_connection = mysql://nova:$MYSQL_PASSWORD@$HOST_IP_ETH1/nova
my_ip = $HOST_IP_ETH1
...
neutron_admin_auth_url = http://$HOST_IP_ETH1:35357/v2.0
...
metadata_listen = $HOST_IP_ETH1
metadata_listen_port = 8775
metadata_host = $HOST_IP_ETH1
