...
[database]
connection = mysql://neutron:$MYSQL_PASSWORD@$HOST_IP_ETH1/neutron
...
[database]
sql_connection = mysql://neutron:$MYSQL_PASSWORD@$HOST_IP_ETH1/neutron
...
[DEFAULT]
auth_url = http://$HOST_IP_ETH1:35357/v2.0
auth_region = RegionOne
admin_tenant_name = $SERVICE_TENANT_NAME
admin_user = neutron
admin_password = $SERVICE_PASSWORD
nova_metadata_ip = $HOST_IP_ETH1
